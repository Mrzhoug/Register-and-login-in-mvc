...
<body>
	...
	<div id="main">
			...
			<table id="formtable">
				...
				<tr>
					...
					<td><input class="userinput" type="text" name="birthday"
						id="birthday" onClick="showCalendar(this.id)" value="${form.birthday }"> <span
						class="message">${form.errors.birthday }</span></td>
				...
				<tr>
					...
					<td><input class="userinput" type="text" name="checkcode"><img
						src="#" height="20px">
					</td>
				</tr>
			</table>
		...
		<div id="formsubmit">
			<span><input class="btn" type="reset" name="reset" value="重 置">
			</span> &nbsp;&nbsp; 
